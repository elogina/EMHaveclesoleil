...
namespace Proxies\__CG__\emh\AgendaBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Agendas extends \emh\AgendaBundle\Entity\Agendas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'slugFr', 'slugEn', 'titreFr', 'titreEn', 'texteFr', 'texteEn', 'sites');
        }
