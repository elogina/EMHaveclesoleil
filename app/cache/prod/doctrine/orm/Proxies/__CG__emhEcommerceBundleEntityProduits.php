 ...
 */
class Produits extends \emh\EcommerceBundle\Entity\Produits implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nomFr', 'nomEn', 'descriptionFr', 'descriptionEn', 'image', 'file', 'prix', 'onoff', 'filenameForRemove');
        }
