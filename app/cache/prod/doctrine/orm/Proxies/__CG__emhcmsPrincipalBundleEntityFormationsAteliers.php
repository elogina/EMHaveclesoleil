 ...
 */
class FormationsAteliers extends \emh\cmsPrincipalBundle\Entity\FormationsAteliers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nomFr', 'nomEn', 'descriptionFr', 'descriptionEn', 'prix', 'date', 'debut', 'fin', 'nbmax', 'dateinscription', 'paye', 'sites', 'membres');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormationsAteliers $proxy) {
