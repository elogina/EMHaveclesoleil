...
";
    ...
    public function block_connection($context, array $blocks = array())
    {
        ...
        if ($this->env->getExtension('security')->isGranted("IS_AUTHENTICATED_REMEMBERED")) {
            ...
            echo "
                ...
                <a href=\"";
            // line 17
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("emh_membres_profil", array("slug" => $this->getAttribute((isset($context["sites"]) ? $context["sites"] : null), "slug"))), "html", null, true);
            echo "\">profil</a>
            ";
        } else {
            // line 19
    ...
    public function block_menu($context, array $blocks = array())
    {
        ...
        <div class=\"menu\">
              ";
        // line 36
        echo $this->env->getExtension('actions')->renderUri($this->env->getExtension('http_kernel')->controller("emhcmsPrincipalBundle:Rubrique:menu", array("slug" => $this->getAttribute((isset($context["sites"]) ? $context["sites"] : null), "slug"))), array());
        // line 37
        echo "\t</div>
        ";
    }
