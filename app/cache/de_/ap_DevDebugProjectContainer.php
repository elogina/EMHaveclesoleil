...
class ap_DevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/wamp/www/EMHaveclesoleil/app/cache/de_/assetic/config'), true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $h->setProxyDir('C:/wamp/www/EMHaveclesoleil/app/cache/de_/doctrine/orm/Proxies');
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:C:/wamp/www/EMHaveclesoleil/app/cache/de_/profiler', '', '', 86400), $a);
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.in_memory')), 'main', $c, $d), 2 => $i, 3 => $k, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '536f78304f623', $c), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'fos_user_security_login', false), NULL, NULL, $c));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/wamp/www/EMHaveclesoleil/app/cache/de_/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/wamp/www/EMHaveclesoleil/app/cache/de_/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
     ...
     *
     * @return emh\MembresBundle\Admin\MembresAdmin A emh\MembresBundle\Admin\MembresAdmin instance.
     */
    protected function getSonata_Admin_MembresService()
    {
        $instance = new \emh\MembresBundle\Admin\MembresAdmin('sonata.admin.membres', 'emh\\MembresBundle\\Entity\\Membres', 'SonataAdminBundle:CRUD');
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/translations', 'debug' => true));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('C:/wamp/www/EMHaveclesoleil/app/cache/de_/assetic/assets');
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/formation/admin/'), array(0 => 'ROLE_ADMIN'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/membre/admin/'), array(0 => 'ROLE_ADMIN'), NULL);
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/wamp/www/EMHaveclesoleil/app/cache/de_');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_',
            ...
            'debug.container.dump' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/ap_DevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/sessions',
            ...
            'profiler.storage.dsn' => 'file:C:/wamp/www/EMHaveclesoleil/app/cache/de_/profiler',
            ...
            'router.resource' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/wamp/www/EMHaveclesoleil/app/cache/de_/doctrine/orm/Proxies',
